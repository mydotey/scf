...
public class LabeledStringProperties {

    private LabeledConfigurationManager _manager;
    ...
    public Property<LabeledKey<String>, String> getStringProperty(LabeledKey<String> key) {
        return getStringProperty(key, null);
    }

    public String getStringPropertyValue(LabeledKey<String> key) {
        return getStringPropertyValue(key, null);
    }

    public Property<LabeledKey<String>, String> getStringProperty(LabeledKey<String> key, String defaultValue) {
        return getStringProperty(key, defaultValue, null);
    }

    public String getStringPropertyValue(LabeledKey<String> key, String defaultValue) {
    ...
    public Property<LabeledKey<String>, Integer> getIntProperty(LabeledKey<String> key) {
        return getIntProperty(key, null);
    }

    public Integer getIntPropertyValue(LabeledKey<String> key) {
        return getIntPropertyValue(key, null);
    }

    public Property<LabeledKey<String>, Integer> getIntProperty(LabeledKey<String> key, Integer defaultValue) {
        return getIntProperty(key, defaultValue, null);
    }

    public Integer getIntPropertyValue(LabeledKey<String> key, Integer defaultValue) {
    ...
    public Property<LabeledKey<String>, Long> getLongProperty(LabeledKey<String> key) {
        return getLongProperty(key, null);
    }

    public Long getLongPropertyValue(LabeledKey<String> key) {
        return getLongPropertyValue(key, null);
    }

    public Property<LabeledKey<String>, Long> getLongProperty(LabeledKey<String> key, Long defaultValue) {
        return getLongProperty(key, defaultValue, null);
    }

    public Long getLongPropertyValue(LabeledKey<String> key, Long defaultValue) {
        return getLongPropertyValue(key, defaultValue, null);
    }

    public Property<LabeledKey<String>, Long> getLongProperty(LabeledKey<String> key, Long defaultValue,
            Function<Long, Long> valueFilter) {
        return getProperty(key, Long.class, defaultValue, StringToLongConverter.DEFAULT, valueFilter);
    }

    public Long getLongPropertyValue(LabeledKey<String> key, Long defaultValue, Function<Long, Long> valueFilter) {
        return getPropertyValue(key, Long.class, defaultValue, StringToLongConverter.DEFAULT, valueFilter);
    }

    public Property<LabeledKey<String>, Float> getFloatProperty(LabeledKey<String> key) {
        return getFloatProperty(key, null);
    }

    public Float getFloatPropertyValue(LabeledKey<String> key) {
        return getFloatPropertyValue(key, null);
    }

    public Property<LabeledKey<String>, Float> getFloatProperty(LabeledKey<String> key, Float defaultValue) {
        return getFloatProperty(key, defaultValue, null);
    }

    public Float getFloatPropertyValue(LabeledKey<String> key, Float defaultValue) {
    ...
    public Float getFloatPropertyValue(LabeledKey<String> key, Float defaultValue, Function<Float, Float> valueFilter) {
        return getPropertyValue(key, Float.class, defaultValue, StringToFloatConverter.DEFAULT, valueFilter);
    }

    public Property<LabeledKey<String>, Double> getDoubleProperty(LabeledKey<String> key) {
        return getDoubleProperty(key, null);
    }

    public Double getDoublePropertyValue(LabeledKey<String> key) {
        return getDoublePropertyValue(key, null);
    }

    public Property<LabeledKey<String>, Double> getDoubleProperty(LabeledKey<String> key, Double defaultValue) {
        return getDoubleProperty(key, defaultValue, null);
    }

    public Double getDoublePropertyValue(LabeledKey<String> key, Double defaultValue) {
    ...
    public Property<LabeledKey<String>, Boolean> getBooleanProperty(LabeledKey<String> key) {
        return getBooleanProperty(key, null);
    }

    public Boolean getBooleanPropertyValue(LabeledKey<String> key) {
        return getBooleanPropertyValue(key, null);
    }

    public Property<LabeledKey<String>, Boolean> getBooleanProperty(LabeledKey<String> key, Boolean defaultValue) {
        return getBooleanProperty(key, defaultValue, null);
    }

    public Boolean getBooleanPropertyValue(LabeledKey<String> key, Boolean defaultValue) {
    ...
    public Property<LabeledKey<String>, List<String>> getListProperty(LabeledKey<String> key) {
        return getListProperty(key, (List<String>) null);
    }

    public List<String> getListPropertyValue(LabeledKey<String> key) {
    ...
    public List<String> getListPropertyValue(LabeledKey<String> key, List<String> defaultValue) {
        return getListPropertyValue(key, defaultValue, StringInplaceConverter.DEFAULT);
    }

    public <V> Property<LabeledKey<String>, List<V>> getListProperty(LabeledKey<String> key,
            TypeConverter<String, V> typeConverter) {
        return getListProperty(key, null, typeConverter);
    }

    public <V> List<V> getListPropertyValue(LabeledKey<String> key, TypeConverter<String, V> typeConverter) {
        return getListPropertyValue(key, null, typeConverter);
    }

    public <V> Property<LabeledKey<String>, List<V>> getListProperty(LabeledKey<String> key, List<V> defaultValue,
            TypeConverter<String, V> typeConverter) {
        return getListProperty(key, defaultValue, typeConverter, null);
    }

    public <V> List<V> getListPropertyValue(LabeledKey<String> key, List<V> defaultValue,
            TypeConverter<String, V> typeConverter) {
    ...
    public Property<LabeledKey<String>, Map<String, String>> getMapProperty(LabeledKey<String> key) {
        return getMapProperty(key, null);
    }

    public Map<String, String> getMapPropertyValue(LabeledKey<String> key) {
    ...
    public Map<String, String> getMapPropertyValue(LabeledKey<String> key, Map<String, String> defaultValue) {
        return getMapPropertyValue(key, defaultValue, StringInplaceConverter.DEFAULT, StringInplaceConverter.DEFAULT);
    }

    public <K, V> Property<LabeledKey<String>, Map<K, V>> getMapProperty(LabeledKey<String> key,
    ...
    public <K, V> Map<K, V> getMapPropertyValue(LabeledKey<String> key, TypeConverter<String, K> keyConverter,
            TypeConverter<String, V> valueConverter) {
        return getMapPropertyValue(key, null, keyConverter, valueConverter);
    }

    public <K, V> Property<LabeledKey<String>, Map<K, V>> getMapProperty(LabeledKey<String> key, Map<K, V> defaultValue,
            TypeConverter<String, K> keyConverter, TypeConverter<String, V> valueConverter) {
        return getMapProperty(key, defaultValue, keyConverter, valueConverter, null);
    }

    public <K, V> Map<K, V> getMapPropertyValue(LabeledKey<String> key, Map<K, V> defaultValue,
            TypeConverter<String, K> keyConverter, TypeConverter<String, V> valueConverter) {
    ...
    public <V> Property<LabeledKey<String>, V> getProperty(LabeledKey<String> key, Class<V> valueType, V defaultValue,
            TypeConverter valueConverter, Function<V, V> valueFilter) {
        PropertyConfig<LabeledKey<String>, V> propertyConfig = createPropertyConfig(key, valueType, defaultValue,
                valueConverter, valueFilter);
        return _manager.getProperty(propertyConfig);
    }

    public <V> V getPropertyValue(LabeledKey<String> key, Class<V> valueType, V defaultValue,
            TypeConverter valueConverter, Function<V, V> valueFilter) {
        PropertyConfig<LabeledKey<String>, V> propertyConfig = createPropertyConfig(key, valueType, defaultValue,
                valueConverter, valueFilter);
    ...
    protected <V> PropertyConfig<LabeledKey<String>, V> createPropertyConfig(LabeledKey<String> key, Class<V> valueType,
            V defaultValue, TypeConverter valueConverter, Function<V, V> valueFilter) {
        return ConfigurationProperties.<LabeledKey<String>, V> newConfigBuilder().setKey(key).setValueType(valueType)
